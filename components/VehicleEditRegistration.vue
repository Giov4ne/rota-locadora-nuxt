    ...
    <div>
        ...
        <!-- <form v-else @submit.prevent="validateForm" id="vehicle-edit-registration-form">
            ...
            <div class="form-body">
                ...
                <div class="custom-field" id="model">
                    <label for="model-c">Descrição</label>
                    <input v-model="newVehicle.vei_descricao" type="text" class="inputs" name="model" required placeholder="Digite o modelo do veículo" id="model-c">
                </div>
                <div class="custom-field" id="year">
                    <label for="year-c">Ano</label>
               ...
               <div class="custom-field" id="color">
                ...
                <div class="custom-field" id="latitude">
                    <label for="latitude-c">Id marca</label>
                    <input v-model="newVehicle.marca_id" type="text" class="inputs" name="latitude" required placeholder="Digite a latitude" id="latitude-c">
                </div>
                <div class="custom-field" id="longitude">
                    <label for="longitude-c">Id modelo</label>
...
<script>
import { ADESOES, NOVA_ADESAO } from '../utils/storeTypes/adesoes';
